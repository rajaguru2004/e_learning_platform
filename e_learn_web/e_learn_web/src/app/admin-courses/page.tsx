                ...
                <main className="flex-1 flex flex-col min-w-0 bg-[#F8F9FB] dark:bg-background-dark/50 overflow-y-auto">
                    ...
                    <div className="px-8 py-6 max-w-7xl mx-auto w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {/* Card 1 */}
                            <div className="group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-xl transition-all border border-gray-100 dark:border-gray-700 overflow-hidden">
                                <div
                            ...
                            <button className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl h-full p-8 group hover:border-primary transition-colors min-h-[300px]">
